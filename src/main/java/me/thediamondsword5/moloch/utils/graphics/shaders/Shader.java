...
public abstract class Shader {
    ...
    public Shader(String fragmentShader, String vertexShader) {
        ...
        try {
            final InputStream vertexStream = getClass().getResourceAsStream("/assets/moloch/shaders/" + vertexShader);
            ...
            final InputStream fragmentStream = getClass().getResourceAsStream("/assets/moloch/shaders/" + fragmentShader);
